...
{
    public partial class frmInversion : frmBase.frmRegistroBase
    {
        public frmInversion()
        {
            InitializeComponent();
        ...
        private void loadInversion()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                txtTasaRescision.Text = oInversionBE.tasaRescision.ToString();
                cboPlazoRescision.Text = Convert.ToString(oInversionBE.plazoRescision);
        ...
        private void saveInversiones()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                oInversionBE.idTipoInversion = Convert.ToString(cboTipoInversion.SelectedValue);
                ...
                oInversionBE.tasaRescision = Convert.ToDecimal(txtTasaRescision.Text);
                oInversionBE.plazoRescision = Convert.ToInt32(cboPlazoRescision.Text);
