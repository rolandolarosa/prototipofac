...
namespace Efide.Tesoreria.DataAccess
{
    public class EntidadesFinancierasDA : IEntidadesFinancierasD
    {
        ...
        public List<BusinessEntity.EntidadesFinancierasBE> obtenerEntidadesFinancieras(BusinessEntity.EntidadesFinancierasBE pEntidadesFinancierasBE)
        {
            List<BusinessEntity.EntidadesFinancierasBE> lstValoresGeneralesBE = new List<BusinessEntity.EntidadesFinancierasBE>();
            IDataReader dr = null;
            try
            {
